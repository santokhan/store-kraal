<template>
    <FixedContainer class="bg-[#343541] text-gray-100">
        ...
        <main class="max-w-screen-xl mx-auto grid lg:grid-cols-2">
            <div :class="['px-4 lg:px-6 py-12', 'text-gray-200 space-y-6']">
                ...
                <div class="grid sm:grid-cols-2 gap-3">
                    <div class="space-y-1" v-for="(item, index) in fileList" :key="index">
                        <div class="grid grid-cols-[3rem_auto_3rem] place-items-center gap-3 py-2 bg-[#343541] rounded-xl">
