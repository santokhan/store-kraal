<template>
  <div ref="chatMain" class="h-full overflow-auto text-white">
    <div v-if="store.database.length === 0" class="max-w-4xl mx-auto px-4 pt-24 flex justify-center">
      <div class="relative w-80">
        <Models />
      </div>
    </div>

    <div v-for="(chat, i) in store.database" :key="i" data-title="chat list">
...
const store = useChatInstanceStore()
