export function res1(fistName: string): string {
    return `Hi ${fistName || 'Nuku'}, \r\nI’m K.AI. You can call me Kai. Here are your linked accounts. \r\n• Bank of America 455666’ \r\n• Yale debt \r\n• US bank loan.`;
}

export function res2(fistName: string): string {
    return `I’ve reviewed all your linked transaction to write your Baseline report. Your Baseline report sets the starting point of our services to you.
...
export function res3(): string {
    return `Here is your baseline report
The purpose of this document is to provide you with financial insights and information about the SD Household and to begin early strategic dialogue. We will work on your 3 year wow strategic plan over the next 90 days.
