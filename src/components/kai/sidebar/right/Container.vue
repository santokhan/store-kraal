<template>
    <aside class="bg-chatgpt-600 text-white fixed lg:relative right-0 top-0 bottom-0">
        ...
        <div v-if="isOpen" class="w-72 lg:w- [320px]  lg:w-[364px] p-4 grid grid-cols-2"
            :class="props.view === 'GRID' ? 'gap-4' : 'gap-3'">
            <slot></slot>
        </div>
    </aside>
</template>
