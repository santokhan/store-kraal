    ...
    <Teleport to="body">
        <ModalContainer>
            <div ref="modal"
                ...
                <div class="">
                    <textarea
                        class="w-full rounded-xl px-3 py-2 placeholder:text-gray-300 border border-chatgpt-400 focus:border-brand-green"
                        rows="2" type="button" aria-haspopup="dialog" aria-expanded="false" aria-controls="radix-:r1d:"
                        data-state="closed"></textarea>
                </div>
                <div class="">
                    <div class="w-full bg-chatgpt-400 rounded-xl relative grid place-items-center">
                        <div class="py-4 grid place-items-center gap-2">
                            <svg class="w-20 h-20" viewBox="0 0 115 115" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="57.5" cy="57.5" r="56.5" stroke="currentColor" stroke-width="2" opacity=".5"
                            ...
                            <p class="text-center text-sm text-gray-400">Upload Document</p>
                        </div>
                        <input type="file" name="" id="" class="absolute inset-0 opacity-0">
                    </div>
                </div>
                <div class="grid place-items-center">
                    <button type="button" class="h-12 rounded-lg bg-indigo-500 text-gray-100 px-12">Submit</button>
                </div>
                <div class="grid sm:grid-cols-2 gap-3">
                    <div class="space-y-1" v-for="(item, index) in [1, 2, 3, 4]" :key="index">
                        <div class="grid grid-cols-[3rem_auto_3rem] place-items-center gap-2 p-2 bg-white/5 rounded-xl">
                            <div class="w-12 h-12 bg-indigo-500 rounded-lg grid place-items-center">
                ...
                <div class="grid sm:grid-cols-2 gap-3">
                    <button type="button"
                        class="h-12 rounded-lg bg-indigo-500 text-gray-100 px-12 flex justify-center items-center gap-2">
                        <div class="w-6 h-6 border-2 rounded-full border-gray-100 grid place-items-center"><i
                                class="fa fa-plus text-xs"></i></div>
                        Add more
                    </button>
                    <button type="button" class="h-12 rounded-lg bg-indigo-500 text-gray-100 px-12">Submit</button>
                </div>
