        ...
        <ModalContainer>
            <div ref="modal"
                ...
                <form class="space-y-3">
                    <div class="relative">
                        <button type="submit" class="absolute inset-y-0 right-3 flex items-center pointer-events-none text-kraal-purple-500">
                        ...
                        <input type="search" id="default-search"
                            class="block w-full px-5 py-4 pr-10 text-sm text-gray-100 rounded-full bg-[#181A1C] focus:outline-none"
                            placeholder="Search" value="" spellcheck="false" />
                    </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                    <div v-for="(item, index) in apiList" :key="index"
                        ...
                        <div>
                            <button type="button"
                                class="h-8 rounded-lg bg-kraal-purple-500 hover:bg-kraal-purple-600 text-gray-100 px-4 text-sm focus:bg-[#EF466F]">Connect</button>
                        </div>
                    </div>
                </div>
            </div>
