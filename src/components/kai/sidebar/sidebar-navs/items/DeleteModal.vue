        ...
        <div class="fixed left-0 top-0 w-full h-screen flex justify-center items-center z-[51] bg-black/10">
            <div class="w-full max-w-lg text-gray-400 bg-chatgpt-600 rounded-xl shadow-lg">
                <div class="flex justify-between items-center p-4">
                    <p class="font-medium text-sm select-none">Delete Chat "{{ props.chat.name }}"</p>
                    <button type="button" class="text-gray-500 hover:text-gray-200" @click="props.handleModal"><i
                            class="fa fa-plus rotate-45" aria-hidden="true"></i></button>
                </div>
                ...
                <form @submit="handleSubmit">
                    <div class="space-y-2 p-4">
                        <label for="chatName" class="font-medium text-sm select-none">To confirm type "{{ props.chat.name
                        }}"
                        ...
                        <button type="submit" :disabled="name ? false : true"
                            ...
                            <span v-else>Delete this chat</span>
                        </button>
                    </div>
                </form>
            </div>
