<template>
    <footer class="text-slate-800 bg-white">
        <div class="max-w-screen-xl mx-auto px-4">
            <div class="grid sm:grid-cols-12 gap-8 py-8 md:py-12">
                <div class="sm:col-span-12 lg:col-span-4 lg:max-w-xs space-y-2">
                ...
                <div v-for="(key, property) in FLinks" :class="[
                    'sm:col-span-6 md:col-span-3 lg:col-span-2', 'text-sm', 'space-y-2'
                ]">
                    <h6 class="font-semibold">{{ property }}</h6>
                    <div class="grid gap-1.5">
                        <RouterLink v-for="(ele) in key" :to="ele.to" class="text-slate-500 hover:text-blue-600">
                            {{ ele.text }}
                        </RouterLink>
                    </div>
                </div>
            ...
            <div class="md:flex md:items-center md:justify-between py-6">
                <div class="flex gap-6 mb-4 md:order-1 md:ml-4 md:mb-0">
