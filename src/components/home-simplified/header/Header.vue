<template>
  <div class="h-14 fixed w-full z-20 top-0 left-0 px-2 flex items-center bg-kraal-dark-600/50 backdrop-blur text-white">
    <div class="max-w-screen-xl mx-auto w-full flex flex-wrap items-center justify-end px-4">
      <RouterLink to="/kraalai" type="button"
        ...
        <UserPro class="w-7" /> {{ currentUserRef ? "" : "Login" }}
      </RouterLink>
    </div>
  </div>
</template>
