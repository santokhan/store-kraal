<template>
  ...
  <div class="shadow-md rounded-2xl border overflow-hidden bg-white p-1">
    <p class="px-3 py-2">
      Can you think of something you bought recently that put a smile on your face?
    </p>

    <div class="space-y-1 h-[400px] overflow-y-auto rounded-xl bordert bg-white">
      <div
        v-for="(ans, index) in newAnswerList"
        :key="index"
        :class="'w-full rounded-lg overflow-hidden px-5 py-4 min-h-[82px] shadow text-white space-y-2 '"
