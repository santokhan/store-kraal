            ...
            <div class="grid sm:grid-cols-12 gap-8 py-8 md:py-12">
                    ...
                    <ul class="text-sm font-medium space-y-2">
                        <li>
                            <RouterLink class="text-slate-500 hover:text-blue-600 transition duration-150 ease-in-out"
                                to="#0">Overview</RouterLink>
                        </li>
                        <li>
                            <RouterLink class="text-slate-500 hover:text-blue-600 transition duration-150 ease-in-out"
                                to="#0">Pricing</RouterLink>
                        </li>
                    </ul>
                </div>
                ...
                <div class="sm:col-span-6 md:col-span-3 lg:col-span-2">
                    ...
                    <ul class="text-sm font-medium space-y-2">
                        <li>
                            <RouterLink class="text-slate-500 hover:text-blue-600 transition duration-150 ease-in-out"
                                to="#0">Micro CFO</RouterLink>
                        </li>
                        <li>
                            <RouterLink class="text-slate-500 hover:text-blue-600 transition duration-150 ease-in-out"
                                to="#0">Corporate Partners</RouterLink>
                        </li>
                    </ul>
                </div>
                ...
                <div class="sm:col-span-6 md:col-span-3 lg:col-span-2">
                    ...
                    <ul class="text-sm font-medium space-y-2">
                        <li>
                            <RouterLink class="text-slate-500 hover:text-blue-600 transition duration-150 ease-in-out"
                                to="#0">About Us</RouterLink>
                        </li>
                        <li>
                            <RouterLink class="text-slate-500 hover:text-blue-600 transition duration-150 ease-in-out"
                                to="#0">Careers</RouterLink>
                        </li>
                    </ul>
                </div>
            </div>
